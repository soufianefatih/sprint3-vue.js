  ...
  <div class="Sign Up" >
   ...
   <section class="col-12 col-md-4 col-lg-4 ">
    ...
    <div class="form-group">
        ...
        <input type="texte" class="form-control form-control-lg"  id="inputname" placeholder="">
    </div>
      <div class="form-group">
        <label for="inputEmail">Email ddress</label>
        <input type="Email" class="form-control form-control-lg" id="inputEmail" placeholder="">
    </div>
    <div class="form-group">
